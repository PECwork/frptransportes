...
.posted-by
{
    ...
    <body>
        <%
         ...
         <br> <button><a href="manter_veiculo.jsp">Manter Veículos</a></br></button>
         <button><a href="<%=Conf.getCaminhoContexto()%>ControleOrdemServico?acao=ListarTodasOs">Gerenciar Ordens de Serviços</a></br></button>
